...
public class PermanentResidentScenario2 extends BaseLogin {
    ...
    public void scenario2() throws InterruptedException, IOException {
        ...
        Commons.enter(driver,By.id(locators.getProperty("household_head_name")),"auto test user2");
        ...
        Commons.enter(driver,By.id(locators.getProperty("head_rid")),"1234-5678-9012-3456-7890-1234-5678-9");
        Commons.enter(driver,By.id(locators.getProperty("head_confirm_rid")),"1234-5678-9012-3456-7890-1234-5678-9");
        ...
        Commons.enter(driver,By.id(locators.getProperty("grand_father_name")),"member2");
...
//        memSelectMonth.selectByVisibleText("April");
        ...
        Commons.enter(driver,By.id(locators.getProperty("enter_member_rid")),"1234-5678-9012-3456-7890-1234-5678-8");
        Commons.enter(driver,By.id(locators.getProperty("confirm_member_rid")),"1234-5678-9012-3456-7890-1234-5678-8");
        Commons.enter(driver,By.xpath(locators.getProperty("member_email")),"mem1@gmail.com");
        ...
        expectedRow.put("Household Name", "auto test user2");
