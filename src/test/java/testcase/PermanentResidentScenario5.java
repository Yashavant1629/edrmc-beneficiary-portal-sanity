...
public class PermanentResidentScenario5 extends BaseLogin {
    ...
    public void scenario1() throws InterruptedException, IOException {
        ...
        Commons.enter(driver,By.id(locators.getProperty("household_head_name")),"auto test user5");
        ...
        expectedRow.put("Household Name", "auto test user5");
