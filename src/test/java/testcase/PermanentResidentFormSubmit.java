...
//        Commons.click(driver, By.id(locators.getProperty("permanent_resident")));
        ...
        Commons.enter(driver,By.id(locators.getProperty("total_number_of_hosehold_members")),"1");
        ...
        Commons.enter(driver,By.id(locators.getProperty("dob")),"2000-03-22");
        WebElement sex = driver.findElement(By.name(locators.getProperty("sex")));
        ...
        Commons.enter(driver,By.id(locators.getProperty("member_email")),"mem@gmail.com");
        ...
        Commons.enter(driver,By.id(locators.getProperty("member_address")),"Bangalore");
        ...
        Commons.click(driver, By.id(locators.getProperty("living_in_abroad")));
        Commons.click(driver, By.name(locators.getProperty("living_in_urban_city")));
        ...
        WebElement microFinance = driver.findElement(By.id(locators.getProperty("micro_finance")));
        Commons.selectByIndex(microFinance,1);
        Commons.dropdown(driver, By.id(locators.getProperty("trade")));
