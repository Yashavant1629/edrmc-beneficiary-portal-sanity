...
public class PermanentResidentScenario1 extends BaseLogin {
    ...
    public void scenarioPR1(String headName, String headEmail, String headUID, String headPhone,
                            String memberName, String memberUID, String memberEmail, String memberPhone,
        ...
        fillHouseholdHeadDetails(headName, headEmail, headUID, headPhone);
        selectAdministrativeLocation();
        addHouseholdMember(memberName, memberUID, memberEmail, memberPhone);
    ...
    private void fillHouseholdHeadDetails(String headName, String headEmail, String headUID, String headPhone) throws InterruptedException {
        ...
        Commons.enter(driver, By.id(locators.getProperty("head_uid")), headUID);
        Commons.enter(driver, By.id(locators.getProperty("head_confirm_uid")), headUID);
    ...
    private void addHouseholdMember(String memberName, String memberUID, String memberEmail, String memberPhone) throws InterruptedException {
        ...
        Commons.enter(driver, By.id(locators.getProperty("enter_member_uid")), memberUID);
        Commons.enter(driver, By.id(locators.getProperty("confirm_member_uid")), memberUID);
